  ...
  eagle: {
    items: [
      ...
      },
      {
        ...
        status: 'theoretical',
        kind: 'concept',
        summary: 'Partner route and SAF / long-range network-path concepts (research).',
        clickable: true,
        capture: 'email',
      },
      {
  ...
  meridian: {
    items: [
      ...
      },
      {
        ...
        status: 'planned',
        kind: 'product',
        summary: 'Hall-marked Earth Line shirt and jacket every mosaic hall wears. List, not a cart.',
        clickable: true,
        capture: 'email',
      },
      {
