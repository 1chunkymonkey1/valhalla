...
export const wolfMission = {
  ...
  body: 'Wolf Transit is a land-mobility arch: electric trail machines first, then ATV, car, truck, and rescue air — each named for a wolf of myth or deep history — culminating in Dire Wolf, a phased transcontinental railroad. Community building and fixing sit under every line: everything is yours to fix, with add-ons from helmets and fix-it kits to hydrogen boost power. We publish a product matrix, not a checkout cart. Fenrir 01 targets January 13, 2027; a new line or model lands every two months on that cadence. Predeposits opening soon. Until then, join the list with your email.',
  cadence:
...
export const wolfMatrix = {
  ...
  emailDone: 'You’re on the Wolf list. We’ll write when this line moves or predeposits open.',
}
