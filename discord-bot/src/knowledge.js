...
export const knowledge = {
  ...
  companies: [
    ...
    { id: 'viking', domain: 'Water', pillar: 'Movement', blurb: 'Sustainable cruises; SMR + sail; Stockholm→London; Phenix pad + moon leg. Board as yourself; disembark as Ragnar or Leif.' },
    ...
    { id: 'aether', domain: 'Space', pillar: 'Habitation', blurb: 'Galactic real estate claims; Hawk Mark 02 plants flags. Phenix marks; Aether claims.' },
  ...
  bifrost:
    'Bifröst is Phenix’s lunar south-pole base camp. Dire Wolf is Wolf’s SF→NYC maglev (5.8-hour network target). They are different programs.',
  direWolf:
