# LvlUp Ventures — Funding Application Copy Pack
**Company:** Valhalla  
**Site:** https://valhallaco.org  
**Apply:** https://lvlup.vc/apply/funding-application  
...
## Founder / contact (typical form fields)
...
**Primary (upload/attach):**  
`/Users/silver/Desktop/valhalla_fundraising/Valhalla-Pitch-Deck.pdf`
...
## Fundraising Stage — recommendation

**Recommend selecting both pathways if the form allows multi-select funds; for Stage pick one:**
...
If burn is near $0 and runway is “N/A / founder-funded,” write that plainly if the form allows text.

---

## Which LvlUp funds / programs to apply

| Fund / program | Apply? | Why |
|----------------|--------|-----|
| **Industry-Agnostic Seed Fund** | **Yes** | DeepTech / multi-domain platform; primary equity fit |
| **First Check Fund** | **Yes** | Strong fit for early/first institutional check, $0 MRR, entity forming |
| **CPG Fund** | **No** (default) | Not a CPG brand story (Meridian garment research alone does not make Valhalla CPG) |
| **CPG Non-Dilutive / CPG Accel** | **No** | Requires CPG traction / ARR-style metrics Valhalla does not claim |
| **E-Commerce Ecosystem Builders** | **No** | Not an e-comm infrastructure thesis |
| **Tech Non-Dilutive** | **No / cautious** | Typically wants ~$10k+ MRR and operating history — Valhalla MRR is $0 |
| **B2B SaaS Non-Dilutive** | **No** | Not B2B SaaS with MRR |
| **Real Economy Non-Dilutive** | **No / cautious** | Brick-and-mortar/services focus; only revisit if a hall is operating as such |
| **Small Business Fund** | **No** | Not the right vehicle for a DeepTech mosaic holdco |
| **LvlUp Labs** | **Cautious / optional** | Useful for hands-on support; apply only if you want the program, not just capital |
| **LvlUp Labs CPG / Marketing Edge** | **No** | CPG/marketing accelerators — poor fit |

**Minimum recommendation:** check **Yes** for Seed Fund + First Check Fund; leave CPG/Labs off unless Eason specifically wants Labs mentorship.

---

## Extra narrative fields (if the form asks)
...
### Competitors
```
Single-domain infrastructure startups and vertical deep-tech firms. Valhalla’s differentiation is the mosaic: each hall is designed to feed the other eleven under one holdco thesis.
```
