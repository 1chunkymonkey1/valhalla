# Partner note — Noah and Micah / Maren-go / Escapes
...
Maren-go calls itself the airfield’s operating system. Public claims on maren-go.com (theirs, not ours):

- AI and autonomous vehicles for industrial and logistical sites, with a specialty in US airfields (DoD and vendors).
- Listed missions: FOD detection and collection, crew deliveries, perimeter protection, wildlife mitigation, surface inspection, mowing, plowing.
- Stack: electric and legacy vehicle autonomy (they name Polaris and HUMVEE), central C2 including third-party vehicles, airfield-grade autonomous driving, mission payloads.
- Expeditionary language: rovers that can be airlifted, survey unprepared ground, and prepare a runway.
- Dual-use language on the same page includes agriculture, agroforestry, and forestry autonomous electric vehicles.
- Site also lists SDVOSB, CMMC v2 level 2, SBIR I/II, and deployments. **Do not repeat those as Valhalla facts or as a Valhalla halo.**

## Identity (do not merge)

Three bins stay separate until Eason says they are the same people:

1. **Today:** Noah and Micah, founder-named, work at Maren-go. The public site does not name them.
2. **Lex archive:** “The Wagners — Twin technical founders, defense AI, highest technical trust.” Micah Wagner appears on the July 3, 2026 SAFE pitch list. Pitch, not a close.
3. **Hermes archive:** “Noka twins” as technical co-founders *in discussions* (dated). Not a hire.
